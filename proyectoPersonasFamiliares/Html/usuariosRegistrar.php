                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="" method="post">
                                            ...
                                            <?php
                                            require 'database.php';
                                            $sql = "SELECT nombre_usuario, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, TIPO_IDENTIFICACION, NUM_IDENTIFICACION, EDAD
                                            ...
                                            while ($results = $records->fetch(PDO::FETCH_ASSOC)) {
                                                $tabla .= "<tr>";
                                                $tabla .= "<td>$results[nombre_usuario]</td>";
                                                ...
                                                $tabla .= "<td>$results[NUM_IDENTIFICACION]</td>";
