...
$sentencia_select = $con->prepare("SELECT nombre_usuario, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, TIPO_IDENTIFICACION, NUM_IDENTIFICACION, EDAD
FROM USUARIO WHERE estadoUS = 'activo' ORDER BY NUM_IDENTIFICACION ASC");
...
if (isset($_POST['btn_buscar'])) {
    ...
    $select_buscar = $con->prepare("SELECT nombre_usuario, PRIMER_NOMBRE, SEGUNDO_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, TIPO_IDENTIFICACION, NUM_IDENTIFICACION, EDAD
FROM USUARIO WHERE estadoUS = 'activo' AND NUM_IDENTIFICACION LIKE :campo ORDER BY PRIMER_NOMBRE ASC;");
...
<html lang="en">
    ...
    <body class="v-light vertical-nav fix-header fix-sidebar">
        <form action="usuariosModificar.php" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="form-validation">
                                            <form class="form-valide" action="#" method="post">
                                                  <center> <h2>Modificar usuarios</h2> </center><br><br>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label">N° identificacion del usuario<span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="buscar" name="buscar" value="<?php if (isset($buscar_text)) echo $buscar_text; ?>" placeholder="Ingrese el N° de identificacion del usuario" onkeyup="this.value = validarNumeros(this.value)" maxlength="20">
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <tr >
                                                                                    ...
                                                                                    <td><?php echo $fila['NUM_IDENTIFICACION']; ?></td>
                                                                                    <td><?php echo $fila['EDAD']; ?></td>
                                                                                    <td><a onclick="modificar(<?php echo $fila['NUM_IDENTIFICACION']; ?>)" class="btn btn-rounded btn-warning" >Modificar</a></td>
                                                                                </tr>
                                                                            <?php endforeach ?>
                                                                            </tr>
