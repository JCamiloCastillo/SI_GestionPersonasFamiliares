...
<html lang="en">
    ...
    <body class="v-light vertical-nav fix-header fix-sidebar">
        <form action="empleadosEliminar.php" method="POST">
                ...
                <div class="content-body">
                    <div class="container">
                        <div class="row page-titles">
                            ...
                            <div class="col p-0">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Persona</a>
                                    </li>
                                    ...
                                    <div class="card-body">
                                        <div class="form-validation">
                                            <form class="form-valide" action="#" method="post">
                                                <center> <h2>Eliminar personas</h2> </center><br><br>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <tr >
                                                                                    ...
                                                                                    <td><a href="../Html/deleteEmpleados.php?id=<?php echo $fila['NUME_IDENTIFICACION']; ?>" class="btn btn-rounded btn-danger">Eliminar</a></td>
                                                                                </tr>
                                                                            <?php endforeach ?>
                                                                            </tr>
